  ...
  const handlePrintReport = () => {
    ...
    const bugRows = bugs.map(bug => `
      <tr>
        ...
        <td>${bug.createdAt ? new Date(bug.createdAt).toLocaleDateString() : 'N/A'}</td>
      </tr>
    `).join('');
        ...
        <body>
          <div class="header">
            ...
            <div class="meta-grid">
              ...
              <div class="meta-item">Created Date: <strong>${project.createdAt ? new Date(project.createdAt).toLocaleDateString() : 'N/A'}</strong></div>
        ...
        >
          ...
          <div style={{ padding: '32px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <div className="report-modal-meta">
              ...
              <div>Created Date: <strong style={{ color: 'var(--text-primary)' }}>{project.createdAt ? new Date(project.createdAt).toLocaleDateString() : 'N/A'}</strong></div>
